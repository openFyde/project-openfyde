...
TARGET_PATH_PREFIX="/home/chronos/user/Web Applications/Manifest Resources"
...
OS_SETTINGS_TARGET_PATH="$TARGET_PATH_PREFIX/$OS_SETTINGS_APPID/$TARGET_PATH_SUFFIX"
CAMERA_APP_TARGET_PATH="$TARGET_PATH_PREFIX/$CAMERA_APPID/$TARGET_PATH_SUFFIX"
